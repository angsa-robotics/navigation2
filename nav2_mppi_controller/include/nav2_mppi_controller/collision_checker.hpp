...
public:
   ...
   * @param x X coordinate of pose to check against in map frame (cell coordinate)
   * @param y Y coordinate of pose to check against in map frame (cell coordinate)  
   * @param yaw Yaw angle of pose to check against in radians
  ...
  /**
   * @brief Convert yaw angle to angle bin index
   * @param yaw Yaw angle in radians
   * @return Angle bin index corresponding to the yaw angle
   */
  unsigned int getAngleBin(float yaw) const;
